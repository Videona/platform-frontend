...
(function () {
	...
	function translate($translateProvider) {
		$translateProvider.translations('en_us', {
			...
			VIDEO_EDIT_THUMBNAIL_CUSTOM_HINT: 'Drag a file or click here.',
			VIDEO_EDIT_VIDEO_FILE: 'Video file',
			VIDEO_EDIT_VIDEO_FILE_HINT: 'Drag a new video or click here to replace.',
			VIDEO_EDIT_VIDEO_FILE_MAX_SIZE: 'Max video size:',
			VIDEO_EDIT_CLICK_MAP_HINT: 'Click on the map to set the video location',
