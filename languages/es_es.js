(function () {
	...
	function translate($translateProvider) {
		$translateProvider.translations('es_es', {
			...
			VIDEO_EDIT_PICK_DATE: 'Seleccione fecha',
			VIDEO_EDIT_THUMBNAIL_DEFAULT: 'Miniatura por defecto',
			VIDEO_EDIT_THUMBNAIL_CUSTOM: 'Miniatura personalizada',
			VIDEO_EDIT_THUMBNAIL_CUSTOM_HINT: 'Arrástralo o haz click aquí.',
			VIDEO_EDIT_VIDEO_FILE: 'Fichero de vídeo',
			VIDEO_EDIT_VIDEO_FILE_HINT: 'Arrastra uno nuevo o haz click para sustituir.',
			VIDEO_EDIT_VIDEO_FILE_MAX_SIZE: 'Tamaño máximo del vídeo:',
			VIDEO_EDIT_CLICK_MAP_HINT: 'Haz click en el mapa para indicar la posición exacta del vídeo',
